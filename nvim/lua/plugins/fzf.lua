...
-- 		-- 	winopts = {
-- 		-- 		height = 0.5, -- Height of the window (30% of the screen)
-- 		-- 		width = 1, -- Full width
-- 		-- 		row = 1, -- Position it at the bottom
-- 		-- 		col = 0,
-- 		-- 		border = "rounded", -- You can choose 'single', 'double', or 'none' too
-- 		-- 		fullscreen = false, -- Keep it as a non-fullscreen window
-- 		-- 	},
-- 		-- })
--
...
-- 				commits = {
-- 					prompt = "Commits❯ ",
-- 					cmd = [[ git log --color --pretty=format:"%C(green)%h%Creset ]]
-- 						.. [[ %C(yellow)[%><(12)%ad%><|(12)]%Creset %C(blue)[%an]%Creset %C(red)%d%Creset %s" ]]
-- 						.. [[ --decorate --date=format:"%a %d/%m/%Y" ]],
...
-- 					cmd = [[ git log --color --pretty=format:"%C(green)%h%Creset ]]
-- 						.. [[ %C(yellow)[%><(12)%ad%><|(12)]%Creset %C(blue)[%an]%Creset %C(red)%d%Creset %s" ]]
-- 						.. [[ --decorate --date=format:"%a %d/%m/%Y" {file} ]],
